...
"""Verify that starting zencoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start zencoin with -h for help text")
        ...
        self.log.info("Start zencoin with -version for version information")
        ...
        self.log.info("Start zencoind with -fakearg to make sure it does not start")
