...
const char * const BITCOIN_CONF_FILENAME = "zencoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Zencoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Zencoin";
#else
    // Unix
    return pathRet / ".zencoin";
#endif
#endif
}
