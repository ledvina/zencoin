...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("162.252.87.163");
        vSeeds.emplace_back("74.50.117.89");

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,81); // Z
...
public:
    CTestNetParams() {
        ...
        base58Prefixes[SCRIPT_ADDRESS2] = std::vector<unsigned char>(1,142);// z
