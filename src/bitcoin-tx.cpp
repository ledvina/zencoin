...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " zencoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  zencoin-tx [options] <hex-tx> [commands]  Update hex-encoded zencoin transaction\n" +
            "or:     zencoin-tx [options] -create [commands]   Create hex-encoded zencoin transaction\n" +
            "\n";
