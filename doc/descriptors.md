# Support for Output Descriptors in Zencoin Core

Since Zencoin Core v0.17, there is support for Output Descriptors. This is a
...
on Zencoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Zencoin Core wallets, a convenience function `combo` is
